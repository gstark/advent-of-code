...
# We can use the overall product of all the divisibles (they are all
# prime) to bound our item levels
overall_mod = monkeys.map { |monkey| monkey[:divisible] }.reduce(:*)
